            ...
            <v-card-text>
              <v-row dense>
                ...
                <v-col cols="12" md="3">
                  <VisVal
                    :val="
                      'IDH ' + item.hospital_id + ' | ' + item.hospital.name
                    "
                    lab="Hospital"
                  />
                </v-col>
              ...
              <v-row>
                ...
                >
                  <v-row dense>
                    <v-col cols="12" md="3">
                      <VisVal
                        :val="doctor_specialty.doctor_specialty_type.name"
                        :lab="'Tipo (' + (i + 1) + ')'"
                      />
                    </v-col>
                    <v-col cols="12" md="3">
          ...
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="3">
                  <VisVal
                    :val="item.bank.bank_type ? item.bank.bank_type.name : null"
                    lab="Banco"
                  />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.bank.account" lab="Cuenta" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.bank.clabe" lab="CLABE" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisDoc
                    :val="item.bank.account_proof_b64"
                    lab="Const. Situación Fisc."
                  />
                </v-col>
                <v-col cols="12" md="3">
                  <VisDoc
                    :val="item.bank.validation_b64"
                    lab="Const. Situación Fisc."
                  />
                </v-col>
              </v-row>
