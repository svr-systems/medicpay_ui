          ...
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                ...
                <v-col cols="12" md="3">
                  <VisDoc :val="item.logo_b64" lab="Logo" img />
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="3">
                  <VisVal :val="item.contact" lab="Nombre" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.contact_phone" lab="Teléfono" />
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="3">
                  <VisDoc :val="item.address.proof_b64" lab="Comp. Domicilio" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.zip" lab="C. P." />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.town.state.name" lab="Estado" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.town.name" lab="Municipio" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.street" lab="Calle" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.exterior" lab="Núm. exterior" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.interior" lab="Núm. interno" />
                </v-col>
                <v-col cols="12" md="3">
                  <VisVal :val="item.address.neighborhood" lab="Colonia" />
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
